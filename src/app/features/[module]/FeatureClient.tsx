...
const MODULE_DEFS: Record<string, ModuleDef> = {
  ...
  'social-media': {
    icon: '📱', color: '#E1306C', pale: '#FDF2F8',
    titleTr: 'Sosyal Medya Hub', titleEn: 'Social Media Hub', titleDe: 'Social-Media-Hub',
    subtitleTr: 'AI ile 5 platform için içerik üretin',
    subtitleEn: 'AI-powered content for all platforms',
    subtitleDe: 'KI-gestützte Inhalte für alle Plattformen',
    tabsTr: [
      { icon: '🤖', title: 'AI İçerik Üretimi', desc: '5 platform için aynı anda içerik oluşturun. Instagram caption, Twitter thread, LinkedIn post, Facebook ve TikTok.' },
      { icon: '🎨', title: 'Marka Sesi Ayarları', desc: 'Okulunuzun marka kimliğini tanımlayın. Ton, hashtag\'ler ve yasaklı kelimeler. Her içerik marka uyumlu.' },
      { icon: '📅', title: 'İçerik Takvimi', desc: 'Paylaşımları önceden planlayın. En iyi saat önerileri. Tüm platformlar tek takvimde.' },
      { icon: '📚', title: 'Hazır Şablonlar', desc: '7 kategori: Mezuniyet, Başarı, Etkinlik, Yeni Dönem, Kayıt, Öğrenci Spotlight. Tek tıkla kullanın.' },
      { icon: '🔒', title: 'KVKK Uyumlu İçerik', desc: 'Öğrenci isimleri veya kimlik bilgileri AI prompta girmez. Güvenli, uyumlu paylaşımlar.' },
      { icon: '📊', title: 'İçerik Kütüphanesi', desc: 'Tüm oluşturulan içerikler kaydedilir. Taslak, planlandı, yayınlandı durumları. Arama ve filtreleme.' },
    ],
    tabsEn: [
      { icon: '🤖', title: 'AI Content Generation', desc: 'Create content for 5 platforms at once. Instagram captions, Twitter threads, LinkedIn posts, Facebook and TikTok.' },
      { icon: '🎨', title: 'Brand Voice Settings', desc: 'Define your school\'s brand identity. Tone, hashtags and forbidden words. Every post is brand-consistent.' },
      { icon: '📅', title: 'Content Calendar', desc: 'Plan posts in advance. Best-time suggestions. All platforms in one calendar.' },
      { icon: '📚', title: 'Ready Templates', desc: '7 categories: Graduation, Achievement, Event, New Term, Enrollment, Student Spotlight. One-click use.' },
      { icon: '🔒', title: 'GDPR-Safe Content', desc: 'Student names or IDs never enter AI prompts. Safe, compliant posts.' },
      { icon: '📊', title: 'Content Library', desc: 'All generated content saved. Draft, scheduled, published statuses. Search and filter.' },
    ],
    tabsDe: [
      { icon: '🤖', title: 'KI-Inhaltserstellung', desc: 'Erstellen Sie Inhalte für 5 Plattformen auf einmal. Instagram-Beschriftungen, Twitter-Threads, LinkedIn-Beiträge, Facebook und TikTok.' },
      { icon: '🎨', title: 'Markenstimmen-Einstellungen', desc: 'Definieren Sie die Markenidentität Ihrer Schule. Ton, Hashtags und verbotene Wörter. Jeder Beitrag ist markenkonsistent.' },
      { icon: '📅', title: 'Inhaltskalender', desc: 'Beiträge im Voraus planen. Beste-Zeit-Vorschläge. Alle Plattformen in einem Kalender.' },
      { icon: '📚', title: 'Fertige Vorlagen', desc: '7 Kategorien: Abschluss, Leistung, Veranstaltung, Neues Semester, Einschreibung, Schüler-Spotlight. Ein-Klick-Nutzung.' },
      { icon: '🔒', title: 'DSGVO-sichere Inhalte', desc: 'Schülernamen oder IDs gelangen nie in KI-Prompts. Sichere, konforme Beiträge.' },
      { icon: '📊', title: 'Inhaltsbibliothek', desc: 'Alle erstellten Inhalte gespeichert. Entwurf-, geplante, veröffentlichte Status. Suchen und filtern.' },
    ],
    benefitsTr: [
      { icon: '⏱️', title: 'Haftada Saatler Kazanın', desc: 'Sosyal medya içeriği oluşturmak için harcanan zamanı %80 azaltın.' },
      { icon: '🎯', title: 'Tutarlı Marka Sesi', desc: 'Her platform için marka uyumlu, profesyonel içerikler.' },
      { icon: '🔒', title: 'KVKK Güvencesi', desc: 'Öğrenci gizliliği korunarak kurum itibarı sağlam kalır.' },
    ],
    benefitsEn: [
      { icon: '⏱️', title: 'Save Hours Every Week', desc: 'Reduce time spent on social media content creation by 80%.' },
      { icon: '🎯', title: 'Consistent Brand Voice', desc: 'Professional, brand-consistent content for every platform.' },
      { icon: '🔒', title: 'GDPR Assurance', desc: 'Student privacy protected, institutional reputation intact.' },
    ],
    benefitsDe: [
      { icon: '⏱️', title: 'Stunden pro Woche sparen', desc: 'Reduzieren Sie den Zeitaufwand für Social-Media-Inhalte um 80%.' },
      { icon: '🎯', title: 'Konsistente Markenstimme', desc: 'Professionelle, markenkonsistente Inhalte für jede Plattform.' },
      { icon: '🔒', title: 'DSGVO-Garantie', desc: 'Datenschutz der Schüler geschützt, Institutionsreputation intakt.' },
    ],
    mockup: null,
    related: ['teacher', 'communication', 'analytics'],
  },

  admin: {
    icon: '👑', color: '#D97706', pale: '#FEF3C7',
    titleTr: 'Admin Paneli', titleEn: 'Admin Dashboard', titleDe: 'Admin-Dashboard',
    subtitleTr: 'Tüm okul yönetimi tek yerden',
    subtitleEn: 'Complete school management in one place',
    subtitleDe: 'Vollständige Schulverwaltung an einem Ort',
    tabsTr: [
      { icon: '👥', title: 'Öğrenci & Öğretmen Yönetimi', desc: 'Toplu CSV import. Öğrenci kaydı, sınıf ataması, öğretmen profil yönetimi. KVKK uyumlu veri silme.' },
      { icon: '🤖', title: 'AI Ders Ataması', desc: 'AI ile öğretmen-ders eşleştirmesi. Yük dengeleme. Uyumluluk kontrolü.' },
      { icon: '📅', title: 'Program Çakışması Tespiti', desc: 'Otomatik çakışma kontrolü. Alternatif öneriler. Haftalık program oluşturma.' },
      { icon: '📊', title: 'Okul Geneli Analitik', desc: 'Tüm sınıflar, öğretmenler ve öğrenciler için kapsamlı raporlar. Risk analizi.' },
      { icon: '🔒', title: 'KVKK Uyumluluk Merkezi', desc: 'Silme günlükleri, AI denetim izi, veri işleme kayıtları. Madde 7 uyumlu kalıcı silme.' },
      { icon: '💳', title: 'AI Kredi Yönetimi', desc: 'Okul bazlı AI kullanım limitleri. Token takibi. Kullanım raporları.' },
    ],
    tabsEn: [
      { icon: '👥', title: 'Student & Teacher Management', desc: 'Bulk CSV import. Student registration, class assignment, teacher profile management. GDPR-compliant data deletion.' },
      { icon: '🤖', title: 'AI Course Assignment', desc: 'AI-powered teacher-course matching. Load balancing. Compatibility check.' },
      { icon: '📅', title: 'Schedule Conflict Detection', desc: 'Automatic conflict checking. Alternative suggestions. Weekly schedule generation.' },
      { icon: '📊', title: 'School-wide Analytics', desc: 'Comprehensive reports for all classes, teachers and students. Risk analysis.' },
      { icon: '🔒', title: 'Compliance Centre', desc: 'Deletion logs, AI audit trail, data processing records. GDPR-compliant permanent deletion.' },
      { icon: '💳', title: 'AI Credit Management', desc: 'School-based AI usage limits. Token tracking. Usage reports.' },
    ],
    tabsDe: [
      { icon: '👥', title: 'Schüler- & Lehrerverwaltung', desc: 'Massen-CSV-Import. Schülerregistrierung, Klassenzuweisung, Lehrerprofilverwaltung. DSGVO-konforme Datenlöschung.' },
      { icon: '🤖', title: 'KI-Kurszuweisung', desc: 'KI-gestützte Lehrer-Kurs-Zuordnung. Lastausgleich. Kompatibilitätsprüfung.' },
      { icon: '📅', title: 'Stundenplandopplung-Erkennung', desc: 'Automatische Kollisionsprüfung. Alternativvorschläge. Wöchentliche Stundenplanerstellung.' },
      { icon: '📊', title: 'Schulweite Analysen', desc: 'Umfassende Berichte für alle Klassen, Lehrer und Schüler. Risikoanalyse.' },
      { icon: '🔒', title: 'Compliance-Center', desc: 'Löschprotokolle, KI-Prüfpfad, Datenverarbeitungsaufzeichnungen. DSGVO-konforme dauerhafte Löschung.' },
      { icon: '💳', title: 'KI-Kreditverwaltung', desc: 'Schulbasierte KI-Nutzungslimits. Token-Verfolgung. Nutzungsberichte.' },
    ],
    benefitsTr: [
      { icon: '⏱️', title: 'İdari Yükü Azaltın', desc: 'Rutin yönetim görevlerini otomatikleştirin, stratejik kararlara odaklanın.' },
      { icon: '📊', title: 'Veri Odaklı Liderlik', desc: 'Gerçek zamanlı analizlerle bilinçli kararlar alın.' },
      { icon: '🔒', title: 'Tam Uyumluluk', desc: 'KVKK ve GDPR gerekliliklerini yerleşik araçlarla karşılayın.' },
    ],
    benefitsEn: [
      { icon: '⏱️', title: 'Reduce Administrative Burden', desc: 'Automate routine management tasks, focus on strategic decisions.' },
      { icon: '📊', title: 'Data-Driven Leadership', desc: 'Make informed decisions with real-time analytics.' },
      { icon: '🔒', title: 'Full Compliance', desc: 'Meet KVKK and GDPR requirements with built-in tools.' },
    ],
    benefitsDe: [
      { icon: '⏱️', title: 'Verwaltungsaufwand reduzieren', desc: 'Routinemäßige Verwaltungsaufgaben automatisieren, auf strategische Entscheidungen konzentrieren.' },
      { icon: '📊', title: 'Datengesteuerte Führung', desc: 'Fundierte Entscheidungen mit Echtzeit-Analysen treffen.' },
      { icon: '🔒', title: 'Vollständige Compliance', desc: 'KVKK- und DSGVO-Anforderungen mit integrierten Tools erfüllen.' },
    ],
    mockup: null,
    related: ['teacher', 'student', 'analytics', 'security'],
  },

  staff: {
    icon: '🏫', color: '#475569', pale: '#F1F5F9',
    titleTr: 'Personel Paneli', titleEn: 'Staff Panel', titleDe: 'Personalpanel',
    subtitleTr: 'Müdür yardımcıları için özel çalışma alanı',
    subtitleEn: 'Dedicated workspace for vice principals',
    subtitleDe: 'Dedizierter Arbeitsbereich für Vize-Schulleiter',
    tabsTr: [
      { icon: '✅', title: 'Devamsızlık Onay İş Akışı', desc: 'Bekleyen bildirimleri incele, onayla veya düzelt. Toplu onay ile hızlı işlem. Her işlem kayıt altında.' },
      { icon: '📊', title: 'Devamsızlık Raporları', desc: 'Sınıf bazlı ve öğrenci bazlı raporlar. Kronik devamsızlık tespiti. Excel export.' },
      { icon: '👥', title: 'Öğrenci Genel Görünümü', desc: 'Salt okunur öğrenci listesi. Sınıf bazlı filtreleme. Temel bilgi erişimi.' },
      { icon: '📢', title: 'Duyuru Oluşturma', desc: 'Tüm okul veya belirli sınıflar için duyuru yayınlayın. Etkinlik oluşturma.' },
    ],
    tabsEn: [
      { icon: '✅', title: 'Attendance Approval Workflow', desc: 'Review pending notifications, approve or correct. Bulk approve for fast processing. Every action logged.' },
      { icon: '📊', title: 'Attendance Reports', desc: 'Class-based and student-based reports. Chronic absenteeism detection. Excel export.' },
      { icon: '👥', title: 'Student Overview', desc: 'Read-only student list. Class-based filtering. Basic info access.' },
      { icon: '📢', title: 'Announcement Creation', desc: 'Publish announcements for the whole school or specific classes. Event creation.' },
    ],
    tabsDe: [
      { icon: '✅', title: 'Anwesenheitsgenehmigungsworkflow', desc: 'Ausstehende Benachrichtigungen prüfen, genehmigen oder korrigieren. Massengenehmigung für schnelle Bearbeitung. Jede Aktion protokolliert.' },
      { icon: '📊', title: 'Anwesenheitsberichte', desc: 'Klassen- und schülerbezogene Berichte. Chronische Fehlzeit-Erkennung. Excel-Export.' },
      { icon: '👥', title: 'Schülerübersicht', desc: 'Schreibgeschützte Schülerliste. Klassenbasierte Filterung. Grundlegender Informationszugang.' },
      { icon: '📢', title: 'Ankündigungserstellung', desc: 'Ankündigungen für die gesamte Schule oder bestimmte Klassen veröffentlichen. Veranstaltungserstellung.' },
    ],
    benefitsTr: [
      { icon: '⚡', title: 'Hızlı İş Akışı', desc: 'Devamsızlık onayları dakikalar içinde tamamlanır.' },
      { icon: '🎯', title: 'Odaklanmış Erişim', desc: 'Rol tabanlı panel — yalnızca ihtiyacınız olan araçlar.' },
      { icon: '📋', title: 'Tam Denetim İzi', desc: 'Her onay ve düzeltme kayıt altında.' },
    ],
    benefitsEn: [
      { icon: '⚡', title: 'Fast Workflow', desc: 'Attendance approvals completed in minutes.' },
      { icon: '🎯', title: 'Focused Access', desc: 'Role-based panel — only the tools you need.' },
      { icon: '📋', title: 'Full Audit Trail', desc: 'Every approval and correction on record.' },
    ],
    benefitsDe: [
      { icon: '⚡', title: 'Schneller Workflow', desc: 'Anwesenheitsgenehmigungen in Minuten abgeschlossen.' },
      { icon: '🎯', title: 'Fokussierter Zugang', desc: 'Rollenbasiertes Panel — nur die Werkzeuge, die Sie brauchen.' },
      { icon: '📋', title: 'Vollständiger Prüfpfad', desc: 'Jede Genehmigung und Korrektur protokolliert.' },
    ],
    mockup: null,
    related: ['admin', 'teacher', 'analytics'],
  },

  security: {
    icon: '🔒', color: '#1E3A5F', pale: '#EEF3FB',
    titleTr: 'Güvenlik & Uyumluluk', titleEn: 'Security & Compliance', titleDe: 'Sicherheit & Compliance',
    subtitleTr: 'Kurumsal düzeyde koruma',
    subtitleEn: 'Enterprise-grade protection',
    subtitleDe: 'Schutz auf Enterprise-Niveau',
    tabsTr: [
      { icon: '🔒', title: 'KVKK & GDPR Uyumluluk', desc: 'Öğrenci kişisel verileri AI sistemlerine gönderilmez. Veri anonimleştirme. Tam uyumluluk merkezi.' },
      { icon: '🛡️', title: 'İki Adımlı Doğrulama', desc: 'Yönetici hesapları için 2FA. Google Authenticator ve Authy desteklenir. QR kod ile kolay kurulum.' },
      { icon: '🔑', title: 'Rol Tabanlı Erişim', desc: 'Admin, Öğretmen, Öğrenci, Veli, Personel, Müdür — 6 farklı rol. Her kullanıcı yalnızca ihtiyacı olanı görür.' },
      { icon: '📋', title: 'Denetim Günlükleri', desc: 'Her AI çağrısı kayıt altında. Hangi veri işlendi, kim tarafından, ne zaman. Tam şeffaflık.' },
      { icon: '🗑️', title: 'Silme Hakkı', desc: 'KVKK Madde 7 uyumlu kalıcı silme. Öğrenci tüm verileri tek tıkla temizlenir. Geri alınamaz işlem onayı.' },
    ],
    tabsEn: [
      { icon: '🔒', title: 'KVKK & GDPR Compliance', desc: 'Student personal data never sent to AI systems. Data anonymisation. Full compliance centre.' },
      { icon: '🛡️', title: 'Two-Factor Authentication', desc: '2FA for admin accounts. Google Authenticator and Authy supported. Easy setup via QR code.' },
      { icon: '🔑', title: 'Role-Based Access', desc: 'Admin, Teacher, Student, Parent, Staff, Principal — 6 distinct roles. Each user sees only what they need.' },
      { icon: '📋', title: 'Audit Logs', desc: 'Every AI call on record. Which data was processed, by whom, when. Full transparency.' },
      { icon: '🗑️', title: 'Right to Erasure', desc: 'GDPR Article 17 compliant permanent deletion. All student data cleared in one click. Irreversible action confirmation.' },
    ],
    tabsDe: [
      { icon: '🔒', title: 'KVKK & DSGVO-Compliance', desc: 'Persönliche Daten der Schüler werden nie an KI-Systeme gesendet. Datenanonymisierung. Vollständiges Compliance-Center.' },
      { icon: '🛡️', title: 'Zwei-Faktor-Authentifizierung', desc: '2FA für Admin-Konten. Google Authenticator und Authy unterstützt. Einfache Einrichtung per QR-Code.' },
      { icon: '🔑', title: 'Rollenbasierter Zugang', desc: 'Admin, Lehrer, Schüler, Eltern, Personal, Direktor — 6 verschiedene Rollen. Jeder Benutzer sieht nur, was er braucht.' },
      { icon: '📋', title: 'Prüfprotokolle', desc: 'Jeder KI-Aufruf aufgezeichnet. Welche Daten verarbeitet, von wem, wann. Vollständige Transparenz.' },
      { icon: '🗑️', title: 'Recht auf Löschung', desc: 'DSGVO-Artikel 17 konforme dauerhafte Löschung. Alle Schülerdaten mit einem Klick gelöscht. Bestätigung irreversibler Aktionen.' },
    ],
    benefitsTr: [
      { icon: '🛡️', title: 'Tam Koruma', desc: 'Öğrenci verileriniz her zaman güvende.' },
      { icon: '⚖️', title: 'Hukuki Uyumluluk', desc: 'KVKK ve GDPR gerekliliklerini otomatik karşılayın.' },
      { icon: '🔍', title: 'Şeffaflık', desc: 'Her işlem izlenebilir ve raporlanabilir.' },
    ],
    benefitsEn: [
      { icon: '🛡️', title: 'Complete Protection', desc: 'Your student data is always secure.' },
      { icon: '⚖️', title: 'Legal Compliance', desc: 'Automatically meet KVKK and GDPR requirements.' },
      { icon: '🔍', title: 'Transparency', desc: 'Every action traceable and reportable.' },
    ],
    benefitsDe: [
      { icon: '🛡️', title: 'Vollständiger Schutz', desc: 'Ihre Schülerdaten sind immer sicher.' },
      { icon: '⚖️', title: 'Rechtliche Compliance', desc: 'KVKK- und DSGVO-Anforderungen automatisch erfüllen.' },
      { icon: '🔍', title: 'Transparenz', desc: 'Jede Aktion nachverfolgbar und berichtbar.' },
    ],
    mockup: null,
    related: ['admin', 'teacher', 'analytics'],
  },
...
export default function FeatureClient({ module: moduleSlug }: { module: string }) {
  const { lang } = useLanguage()
  const [activeTab, setActiveTab] = useState(0)

  useEffect(() => {
    trackEvent('feature_view', 'engagement', moduleSlug)
  }, [moduleSlug])

  const mod = MODULE_DEFS[moduleSlug]
  if (!mod) {
    return (
  ...
  const modLabel = MODULE_LABELS[moduleSlug]
